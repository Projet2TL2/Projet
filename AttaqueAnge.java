public class AttaqueAnge extends Attaque{
	 ...
	 * @param : centre le centre de l'attaque
	 */
	public AttaqueAnge(String nom, int cout, Case centre) {
	...
	private void calculSurface(Case centre) {
		...
		surface[3] = new Case(centre.getColonne(),centre.getLigne()-1);
		surface[4] = new Case(centre.getColonne(),centre.getLigne()+1);
		surface[5] = new Case(centre.getColonne(),centre.getLigne()+2);
	}
}
